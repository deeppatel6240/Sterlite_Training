...
// ---->// Code for database operations
		...
		// Product product = ss.get(Product.class, 3005);
		// System.out.println(product);

		// insert an object as new row in product

		// transient object
		// Product p = new Product(7014, "Fan", "Samsung", (float) 1999.00);
		// persistent object
		// ss.save(p);

		/*
		 * Product pro = ss.load(Product.class, 9014); System.out.println("Product Id: "
		...
		/*
		 * Product p = ss.get(Product.class, 7014);
		 * 
		 * if (p != null) { ss.delete(p); } else {
