...
/**
 * Servlet implementation class ProductSortServletByPriceDesc
 */
@WebServlet("/ProductSortServletByPriceDesc")
public class ProductSortServletByPriceDesc extends HttpServlet {
