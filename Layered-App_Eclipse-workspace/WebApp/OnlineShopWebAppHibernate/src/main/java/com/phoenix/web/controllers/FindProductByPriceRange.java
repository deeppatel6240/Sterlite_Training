...
/**
 * Servlet implementation class FindProductByPriceRange
 */
@WebServlet("/FindProductByPriceRange")
public class FindProductByPriceRange extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(flag == false ) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("FindProductByPriceRange.html");
