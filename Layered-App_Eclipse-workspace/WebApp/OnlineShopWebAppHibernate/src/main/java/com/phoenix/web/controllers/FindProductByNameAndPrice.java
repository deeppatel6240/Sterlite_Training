...
/**
 * Servlet implementation class FindProductByNameAndPrice
 */
@WebServlet("/FindProductByNameAndPrice")
public class FindProductByNameAndPrice extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(flag == false ) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("FindProductByNameAndPrice.html");
